...
def test_prune_query_filter_state_keeps_only_bucket_keys_in_bucket_mode_and_prunes_legacy_secondary_foreign_keys():
    query_state = {
        "foreign_buy_filter_mode": "구간 선택",
        "foreign_buy_bucket": "0~100억",
        "foreign_buy_min_custom": "100000000",
        "foreign_buy_max_custom": "200000000",
    ...
    assert pruned["foreign_buy_bucket"] == "0~100억"
    ...
    assert "foreign_buy2_bucket" not in pruned
